...
const API_PROXY_URL = '/api/kodik';

const apiClient = axios.create({
    baseURL: API_PROXY_URL,
    timeout: 65000, // !!! УВЕЛИЧЕН ТАЙМАУТ КЛИЕНТА до 65 секунд !!!
});
...
// Функция searchKodikPlayer (остается как есть)
...
// УДАЛЕНА fetchKodikList, т.к. главная использует Shikimori